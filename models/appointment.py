...
# Association table for many-to-many relationship between Appointment and Service
...
class Appointment(db.Model):
    ...
    offer = db.relationship('Offer', backref=db.backref('appointments', lazy=True))
    ...
    def to_dict(self):
        return {
            ...
            'offer_discount': self.offer.discount_percent if self.offer else 0
        }
...
# Association table for many-to-many relationship between Booking and Service
...
class Booking(db.Model):
    ...
    offer = db.relationship('Offer', backref=db.backref('bookings', lazy=True))
